...
\begin{enumerate}
  ...
  \begin{enumerate}[leftmargin=0in]
    ...
    \textbf{Exception:} A lone Barbarian unit at strength 1 will not enter an enemy-occupied area. It may join another attacking force; otherwise, it remains in place.
