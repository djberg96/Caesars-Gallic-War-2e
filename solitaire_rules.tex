...
If you wish to play this game solitaire, then you will play as the Romans and attempt to match Caesar's historical accomplishments. There is a change in the setup, as well as special rules that will govern how the Barbarian "bot" behaves.
...
The board setup is identical to the normal 2-player game. However, only deal cards only to yourself, the Roman player, at the start of each turn as per the 2-player rules.
