...
\begin{enumerate}
  ...
  \item If the card revealed is a Minor Revolt, then select a tribe random randomly using the Random Tribe Selection table. Continue to re-roll if the tribe is already controlled by the Barbarian bot.
  
  \item If the card revealed is a Major Revolt, then select one tribe randomly using the Random Tribe Selection table. Continue to re-roll if a tribe is already controlled by the bot or occupied an enemy unit. Then randomly select a second, adjacent and tribal area that is not occupied by an enemy unit. Both areas are now controlled by the bot.
  ...
  \begin{itemize}
    \item Barbarian units in their home area will fight to the death, except German units in Germania, which might strategically withdraw.
    ...
    \textbf{Exception:} Barbarian units in their home area will remain and retreat into a fortress, if present.
