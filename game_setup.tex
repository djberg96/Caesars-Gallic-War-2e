...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.20\linewidth, angle=90]{Legion_XI.png}
  \hspace{10mm}
  \includegraphics[width=0.20\linewidth, angle=90]{Legion_XII.png}
...
Legions I, XIII, XIV, and XV start in the Roman player's force pool and may be built during the course of the game. Legions V and VI are not in play at the start of the game, set them aside for now.
