...
\par
After collecting supply points, the Roman player has up to three new legions in his force pool - legions XIII, XIV and XV - that can be constructed over the course of the game. The cost is one supply point per strength point, up to four strength points maximum (though less if desired). A maximum of one new legion per turn may be brought onto the map as a reinforcement.
