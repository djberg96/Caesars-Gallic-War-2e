...
\begin{center}
  \includegraphics[width=0.30\linewidth]{Helvetii.png}
    \hspace{1mm}
    \raisebox{6.5\height}{\Large$\rightarrow$}
    \hspace{1mm}
  \includegraphics[width=0.30\linewidth]{Nantuates.png}
\end{center}
...
\par
The Roman player has four legions in his force pool at the start of the game - legions I, XIII, XIV and XV - which can be built over the course of the game.

After collecting supply points, the Roman player may build one of these legions as a reinforcement. The cost is one supply point per strength point, up to four strength points maximum (though less if desired). Only one new legion per turn may be brought onto the map as a reinforcement.

\textbf{Exception:} If the \textit{Massive Revolt} event has been played then two additional units - legions V and VI - are added to the Roman force pool and may be built by the Roman player. For the rest of the game up to \textbf{two} legions per turn can be brought onto the map as reinforcements.
...
\subsubsection{Arriving Legions} \label{Arriving Legions}
\par
Roman Legions that were already in the Off-Map area at the start of the Roman Reinforcement phase may move into Transalpine Gaul as a free move. Roman Legions that were constructed this turn, or returned from elimination this turn, may not use this free move.
