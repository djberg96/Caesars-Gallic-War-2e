...
Once played, the subjugated tribe is removed from the map and placed in the Subjugated Tribes area on the board. It can no longer be the target of any further actions or events while subjugated, except unsubjugation by the Barbarian player (see below). Subjugated tribes are worth VP to the Roman player at the end of each turn.
