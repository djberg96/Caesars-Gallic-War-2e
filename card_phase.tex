...
\textbf{Exception:} Each Roman legion unit in the Off-Map area is considered its own group, i.e. they must be moved onto the map one at a time (unless using a free move; see rule \ref{Arriving Legions}), and only into Transalpine Gaul. Barbarian units may not enter the off-map area.
\par
