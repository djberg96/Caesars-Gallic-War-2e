...
There are six possible actions and they are resolved in the following order: Event, Supply Action, Neutral Tribe Activation, Political Action, Subjugation or Movement. If both players select the same action, the Romans resolve their action first.
...
If the die roll is less than or equal to the Action Point value on the card played, the Political Action is successful and control is switched to the active player. The Gallic's tribe block is immediately returned to its home area (if not already home) at their current strength. If there are enemy units present then a battle is immediately fought (see 5.2.2 Battles). The unit returning home is considered the attacker.
...
\textbf{E. Subjugation}
\par
The Roman player may choose to subjugate a Gallic tribe. In order to do so at least one Roman legion unit must be in the same area as the tribe being subjugated, and the home area on the card must match the home area of the Gallic tribe being subjugated. In addition, the tribe being subjugated must either already be a Roman ally, or have been eliminated earlier in the turn (or possibly both). German units may never be subjugated.

Once played, the subjugated tribe is removed from the map and placed in the Subjugated Tribes area on the board. It can no longer be the target of any further actions or events while subjugated, except unsubjugation by the Barbarian player. Subjugated tribes are worth VP to the Roman player at the end of each turn.

The Barbarian player may use this action to unsubjugate a Gallic tribe. In order to do so the home area on the card must match the name of the subjugated tribe, and the area cannot be occupied by an enemy unit. Once played, the subjugated tribe is returned, face down, to its home area.

Note that in areas which contain two different tribes, you may only subjugate or unsubjugate one of those tribes per Subjugation Action.
...
Exception: Roman units may not cross the Rhine into Germania if there are no German units there.
